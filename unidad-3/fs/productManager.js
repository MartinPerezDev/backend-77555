...
async function main(){
  try {
    ...
    //await productManager.addProduct( { title: "Campera de jean", price: 5290, stock: 2 } );
    //await productManager.setProductById("8a8f0d79-228e-4c11-9987-34e1ce30b1a6", { price: 12000 })
    await productManager.deleteProductById("44deb36e-5600-4380-acc8-372a8f078551");
